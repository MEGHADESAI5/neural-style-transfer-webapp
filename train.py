...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str,
                    default=r'C:\Users\Megha\OneDrive\Desktop\AI_NST_PROJECT\content_data')

    parser.add_argument('--style_dir', type=str,
                    default=r'C:\Users\Megha\OneDrive\Desktop\AI_NST_PROJECT\style_data')

    parser.add_argument('--vgg', type=str,
                    default=r'C:\Users\Megha\OneDrive\Desktop\AI_NST_PROJECT\vgg_normalised.pth')
